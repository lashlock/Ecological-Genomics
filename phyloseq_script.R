...
pheno <- phyloseq_to_deseq2(phylo_subset, ~  Phenotype)
...
#Plot taxa by location .... left off here #########################################
...
title <- "New.CleanUp.ReferenceOTU5876647"
data <- plotCounts(pheno_deseq_test, "New.CleanUp.ReferenceOTU5876647" , 
