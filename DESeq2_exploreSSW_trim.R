...
# The last term in the model is what is tested.  In this case health.
#  This is not the same as an interaction.
#Measuring the health effect while controlling for the location and day
#controlling for differences due to day and location page 26-27 manual DESeq2.pdf
