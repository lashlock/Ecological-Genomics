...
#What's the effect of health, given the location an individual is from 
#main effect of last term, controlling for the first term
...
dim(dds)
#[1] 12954    77  # at > 100 genes that were mapped to; we loose many fewer genes than before with this 
#new transcriptome assembly


# For practice, let's work with fewer genes so that the models can run faster...
dds <- dds[sample(nrow(dds), 1200), ] #sample by row, 1200 of our 12000 rows
dim(dds)
#output
#[1] 1200   77
...
#sick wrt healthy (since we set healthy as our reference)
